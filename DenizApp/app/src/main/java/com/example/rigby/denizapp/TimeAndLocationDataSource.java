...
public class TimeAndLocationDataSource {
        ...
        private String[] allColumns = { SQLLiteDBHelper.COLUMN_ID,
                SQLLiteDBHelper.COLUMN_TIME, SQLLiteDBHelper.COLUMN_NICOTIN, SQLLiteDBHelper.COLUMN_LOCATION };
        ...
        public TimeAndLocation createTime(String time, String date, String location) {
            ContentValues values = new ContentValues();
            values.put(SQLLiteDBHelper.COLUMN_TIME, time);
            values.put(SQLLiteDBHelper.COLUMN_NICOTIN, date);
            values.put(SQLLiteDBHelper.COLUMN_LOCATION, location);

            long insertId = database.insert(SQLLiteDBHelper.TABLE_TIMELOCATION, null,
                    values);
            /*Cursor cursor = database.query(SQLLiteDBHelper.TABLE_TIMELOCATION,
                    allColumns, SQLLiteDBHelper.COLUMN_ID + " = " + insertId, null,
                    null, null, null);*/
        ...
        private TimeAndLocation cursorToTime(Cursor cursor) {
            ...
            timeAndLoc.setLocation(cursor.getString(3));
            return timeAndLoc;
        }
